    ...
    return (
        <div className="table-selector">
            <div className="table">
                ...
                <div className="seat bottom-right" />
                <div className="seat bottom" />
                <div className="seat bottom-left" />
            ...
            <style>
                ...
                .table {
                    ...
                    background-color: #f0f0f0; /* Table color */
            ...
            <section className="flex flex-col lg:flex-row lg:items-start">
                ...
                <div className="lg:w-8/12 h-full lg:order-2 lg:border-r">
                    <div className="flex items-center gap-2 py-1 border-b pl-4">
                        ...
                        <p className="tex-xs font-plus text-gray-500">Guests</p>
                    </div>

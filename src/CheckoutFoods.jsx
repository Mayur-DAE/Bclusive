            ...
            <section className="flex flex-col lg:flex-row lg:items-start">
                ...
                <div className="lg:w-8/12 h-full lg:order-2 lg:border-r">
                    ...
                    <div className="p-4">
                        ...
                        <p className="text-red-600 font-bold">Please use food content as it is as that is responsive. (Replace here with that element) food and bar</p>

            ...
            <div className="px-6 mt-8">
                <div className="flex flex-col md:flex-row items-center justify-start gap-2 w-full box-border mb-12">
                    ...
                    <div className="px-2 w-full md:w-auto">
                        <div className="flex gap-2 items-center justify-center bg-primary-dark hover:bg-primary-dark/90 cursor-pointer text-white rounded-2xl h-[50px] py-2 px-6">
                    ...
                    <div className="px-2 w-full md:w-auto">
                        <div className="flex gap-2 items-center justify-center bg-primary-dark hover:bg-primary-dark/90 cursor-pointer text-white rounded-2xl h-[50px] py-2 px-6" onClick={toggleFilterModal}>
                            <p className="text-lg font-plus">
                                Filter
                            </p>
                        </div>
                ...
                {isFilterModalOpen && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-[2000]">
                        <div className="bg-white p-6 rounded-lg shadow-lg w-full lg:w-1/2">
                            ...
                            <button className="bg-primary-dark text-white py-2 px-4 rounded" onClick={toggleFilterModal}>
                                Apply Filters
                            </button>
                            <button className="ml-2 py-2 px-4 rounded" onClick={toggleFilterModal}>
                                Close
                            </button>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-12 gap-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 col-span-12 lg:col-span-8">
                    ...
                    <div className="col-span-4 hidden lg:block">
                        <LoadScript googleMapsApiKey="YOUR_GOOGLE_MAPS_API_KEY">
                            ...
                            >
                                {listingsData.map((listing, index) => (
                                    <Marker key={index} position={listing.location} />
                                ))}
                            </GoogleMap>
                        </LoadScript>
                    </div>
